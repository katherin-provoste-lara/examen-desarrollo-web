...
@section('content')
                    ...
                    <div class="card  bg-welcome-img overflow-hidden">
                        <div class="card-body">
                            <div class="">
                                ...
                                <img src="/images/extra/fund.png" alt="" class=" mb-n4 float-end" height="107">
                            </div>
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div><!--end col-->
    ...
    <div class="row">
        <div class="col-12"><h4 class="mb-3">Gestión del negocio</h4></div>
        <div class="col-md-4">
            <a href="{{ route('usuarios.index') }}" class="text-decoration-none">
                <div class="card border-primary"><div class="card-body"><div class="d-flex justify-content-between"><div><p class="text-muted mb-1">Usuarios</p><h3 class="mb-0">{{ $totalUsuarios ?? 0 }}</h3></div><i class="iconoir-group fs-1 text-primary"></i></div><span class="text-primary small">Administrar usuarios <i class="fas fa-arrow-right ms-1"></i></span></div></div>
            </a>
        </div>
        <div class="col-md-4">
            <a href="{{ route('clientes.index') }}" class="text-decoration-none">
                <div class="card border-info"><div class="card-body"><div class="d-flex justify-content-between"><div><p class="text-muted mb-1">Clientes</p><h3 class="mb-0">{{ $totalClientes ?? 0 }}</h3></div><i class="iconoir-community fs-1 text-info"></i></div><span class="text-info small">Administrar clientes <i class="fas fa-arrow-right ms-1"></i></span></div></div>
            </a>
        </div>
        <div class="col-md-4">
            <a href="{{ route('productos.index') }}" class="text-decoration-none">
                <div class="card border-warning"><div class="card-body"><div class="d-flex justify-content-between"><div><p class="text-muted mb-1">Productos</p><h3 class="mb-0">{{ $totalProductos ?? 0 }}</h3></div><i class="iconoir-box fs-1 text-warning"></i></div><span class="text-warning small">Administrar productos <i class="fas fa-arrow-right ms-1"></i></span></div></div>
            </a>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class=" text-center mx-auto">
                        <img src="/images/extra/rabit.png" alt="" class="d-inline-block" height="105">
                    </div>
                        ...
                        <div class="p-3 bg-primary-subtle rounded position-relative">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="my-0 fw-normal text-dark fs-13 mb-0">You have $1.53 remaining found over
                                        ...<a href="#" class="text-primary fw-medium mb-0 text-decoration-underline">View
                                            Details</a></h6>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/flags/us_flag.jpg"
                            ...
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/flags/spain_flag.jpg"
                                             class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                            ...
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/flags/french_flag.jpg"
                                             class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                ...
                                <td class="px-0 text-end"><span
                                        class="text-body ps-2 align-self-center text-end fw-medium">0.875433 <span
                                            class="badge rounded text-danger bg-danger-subtle">0.11%</span></span></td>
                            </tr><!--end tr-->
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                            ...
                            <tr class="">
                                <td class="px-0 pb-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/flags/baha_flag.jpg"
                                             class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                ...
                                <td class="px-0 pb-0 text-end"><span
                                        class="text-body ps-2 align-self-center text-end fw-medium">0.845236 <span
                                            class="badge rounded text-danger bg-danger-subtle">0.22%</span></span></td>
                            </tr><!--end tr-->
                            </tbody>
                        </table> <!--end table-->
                    </div><!--end /div-->
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="/images/logos/lang-logo/chatgpt.png" height="40"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="/images/logos/lang-logo/gitlab.png" height="40"
                                             class="me-3 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="/images/logos/lang-logo/nextjs.png" height="40"
                                             class="me-3 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="/images/logos/lang-logo/vue.png" height="40"
                                             class="me-3 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                                            <h6 class="m-0">Vue</h6>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="/images/logos/lang-logo/symfony.png" height="40"
                                             class="me-3 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tr class="">
                                ...
                                <td class="px-0 text-end"><a href="#" class="text-body"><i class="las la-sync-alt"></i></a>
                                </td>
                            </tr><!--end tr-->
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/users/avatar-2.jpg" height="36"
                                             class="me-2 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                            ...
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/users/avatar-3.jpg" height="36"
                                             class="me-2 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                            ...
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/users/avatar-4.jpg" height="36"
                                             class="me-2 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                            ...
                            <tr>
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/users/avatar-5.jpg" height="36"
                                             class="me-2 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                            ...
                            <tr class="">
                                <td class="px-0">
                                    <div class="d-flex align-items-center">
                                        <img src="/images/users/avatar-9.jpg" height="36"
                                             class="me-2 align-self-center rounded" alt="...">
                                        <div class="flex-grow-1 text-truncate">
                                            <h6 class="m-0 text-truncate">Steven Sharp </h6>
                                            <a href="#" class="font-12 text-muted text-decoration-underline">#4521</a>
...
@section('script')
    ...
    @vite(['resources/js/pages/index.init.js','resources/js/DynamicSelect.js'])
@endsection
